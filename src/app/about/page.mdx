...
import PoleVault from '../../../public/pole-vault.jpg'
import CrossCountryRace from '../../../public/cross-country-race.jpg'
import Track400m from '../../../public/track-400.jpg'
...
* **TODAY**: Looking for new opportunities post-Camio, particularly in AI, LLMs, and startups (or teams in bigger companies that function like startups) and working on a few side project that I hope to release soon.
...
### Pole Vaulting
    ...
    <MarkdownVideo src="/pole-vault-vid.mp4" caption="This is from when I was competing unattached post-college" />
...
I've been skiing since I could walk. I absolutely love it and try to go as much as possible. Usually, during the winter you will find me on a ski trip either with family or friends. Below are some obligatory videos of my skiing prowress:
    ...
    <LazyMarkdownVideo src="/skiing.mp4" caption="I'm a professional" />
