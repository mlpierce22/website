...
My philosophy centers on creating software that genuinely solves problems, blending hard work with consistent innovation. Highlights of my career thus far include spearheading initiatives at the Tech4good lab, being an early engineer at Camio and leading key projects. During my time at Camio, I worked across the stack, in everything from architecting the [Camio website](www.camio.com) to implementing the heartbeat and setup of our on-premise firmware in kubernetes. I left Camio after our latest round of funding and am currently looking for my next opportunity! Please reach out if you think I'd be a good fit for your team!

Looking ahead, I'm excited about opportunities in AI and LLMs, particularly in roles that merge technical expertise with impactful leadership.
